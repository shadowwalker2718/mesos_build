...
#ifndef PROTOBUF_mesos_2fallocator_2fallocator_2eproto__INCLUDED
#define PROTOBUF_mesos_2fallocator_2fallocator_2eproto__INCLUDED
...
namespace protobuf_mesos_2fallocator_2fallocator_2eproto {
...
class InverseOfferStatus : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:mesos.allocator.InverseOfferStatus) */ {
 public:
  InverseOfferStatus();
  ...
  const ::mesos::TimeInfo& timestamp() const;
  ::mesos::TimeInfo* release_timestamp();
  ::mesos::TimeInfo* mutable_timestamp();
  void set_allocated_timestamp(::mesos::TimeInfo* timestamp);

  // required .mesos.allocator.InverseOfferStatus.Status status = 1;
  bool has_status() const;
  void clear_status();
  static const int kStatusFieldNumber = 1;
  ::mesos::allocator::InverseOfferStatus_Status status() const;
  void set_status(::mesos::allocator::InverseOfferStatus_Status value);
 ...
 private:
  ...
  int status_;
  friend struct ::protobuf_mesos_2fallocator_2fallocator_2eproto::TableStruct;
  friend void ::protobuf_mesos_2fallocator_2fallocator_2eproto::InitDefaultsInverseOfferStatusImpl();
};
// ===================================================================
...
inline ::mesos::FrameworkID* InverseOfferStatus::release_framework_id() {
  // @@protoc_insertion_point(field_release:mesos.allocator.InverseOfferStatus.framework_id)
...
inline const ::mesos::TimeInfo& InverseOfferStatus::timestamp() const {
  const ::mesos::TimeInfo* p = timestamp_;
...
inline ::mesos::TimeInfo* InverseOfferStatus::release_timestamp() {
  // @@protoc_insertion_point(field_release:mesos.allocator.InverseOfferStatus.timestamp)
  clear_has_timestamp();
...
#endif  // PROTOBUF_mesos_2fallocator_2fallocator_2eproto__INCLUDED
